...
su gpadmin -l -c "export COORDINATOR_DATA_DIRECTORY=/data0/database/master/gpseg-1;source ${INSATALL_PATH}/greenplum_path.sh;psql -d template1 -c \"alter user gpadmin password 'Hashdata@123'\""
