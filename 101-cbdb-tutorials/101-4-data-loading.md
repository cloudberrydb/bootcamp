...
This tutorial briefly introduces 3 methods to load the example data `FAA` into Cloudberry Database tables you have created in the previous tutorial [Lesson 3: Create Tables](../101-cbdb-tutorials/101-3-create-tables). Before continuing, make sure you have completed the previous tutorial.
...
In [Lesson 3: Create Tables](../101-cbdb-tutorials/101-3-create-tables), you have created 6 tables in the `tutorial` database, one of which is `d_cancellation_codes` in the `faa` directory.
